/*
 * $Id: EditBook.java 4839 2006-03-09 08:57:47Z jonathanlocke $ $Revision:
 * 1.13 $ $Date: 2006-03-09 16:57:47 +0800 (Thu, 09 Mar 2006) $
 *
 * ==================================================================== Licensed
 ...
 */
public final class EditBook extends LibraryHomePage
{
    /**
    ...
    public static PageLink link(final String name, final long id)
    {
        return new PageLink(name, new IPageLink()
        {
            public Page getPage()
            {
                Library library = Activator.getLibrary();
                return new EditBook( library.findBookById( id ) );
            }
    ...
    static public final class EditBookForm extends Form
    {
        ...
        public EditBookForm(final String id, final Book book)
        {
            ...
            final FormComponentFeedbackBorder authorFeedback = new FormComponentFeedbackBorder("authorFeedback");
            add(authorFeedback);
            ...
            Library library = Activator.getLibrary();
            Collection<Book> allBooks = library.findAllBooks();
