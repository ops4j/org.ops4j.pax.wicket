...
public class FloorContentAggregator extends AbstractContentAggregator<FloorPanel>
    ...
    public AbstractTab createTab( Locale locale )
    {
        ...
        return new AbstractTab( title )
        {
            ...
            public Panel getPanel( String panelId )
            {
                ...
                FloorContentAggregator floorContentContainer = instance.getFloorContentContainer( floorName );
