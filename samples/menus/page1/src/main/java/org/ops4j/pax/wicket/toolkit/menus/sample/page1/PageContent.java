...
public class PageContent extends AbstractPageContent
{

    private DefaultPageContainer m_pageContainer;

    protected PageContent( BundleContext bundleContext, DefaultPageContainer pageContainer, String applicationName, String pageName )
    ...
    {
        return new Page( m_pageContainer );
    }
}
