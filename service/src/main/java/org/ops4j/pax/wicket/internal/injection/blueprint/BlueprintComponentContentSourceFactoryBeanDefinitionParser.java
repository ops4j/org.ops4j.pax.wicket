...
public class BlueprintComponentContentSourceFactoryBeanDefinitionParser extends AbstractBlueprintBeanDefinitionParser {
    ...
    protected void extractRemainingMetaData(Element element, ParserContext context, MutableBeanMetadata beanMetadata)
        ...
        addPropertyReferenceFromElement("componentContentSourceFactory", element, context, beanMetadata);
    }
