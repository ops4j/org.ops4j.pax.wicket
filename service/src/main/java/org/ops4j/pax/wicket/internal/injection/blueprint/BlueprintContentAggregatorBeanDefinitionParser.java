...
public class BlueprintContentAggregatorBeanDefinitionParser extends AbstractBlueprintBeanDefinitionParser {
    ...
    protected void extractRemainingMetaData(Element element, ParserContext context, MutableBeanMetadata beanMetadata)
        ...
        addPropertyValueFromElement("aggregationPointName", element, context, beanMetadata);
    }
