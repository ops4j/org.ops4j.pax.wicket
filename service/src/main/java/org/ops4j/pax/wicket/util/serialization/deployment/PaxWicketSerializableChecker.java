...
{
    private static final Logger logger = LoggerFactory.getLogger(PaxWicketSerializableChecker.class);
    ...
    /** log. */
    private static final Logger log = LoggerFactory.getLogger(PaxWicketSerializableChecker.class);
    ...
    private void internalCheck(Object obj)
    {
        ...
        if (!(obj instanceof Serializable) && !Proxy.isProxyClass(cls) && validateAdditionalSerializableConditions(obj))
        {
            ...
            if (writeObjectMethod != null)
            {
                class InterceptingObjectOutputStream extends ObjectOutputStream
                {
                    ...
                    protected Object replaceObject(Object streamObj) throws IOException
                    {
                        ...
                        streamObj = additionalObjectReplacements(streamObj);
