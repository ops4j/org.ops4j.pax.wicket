...
/** Classes that want to register WicketPages just implements this interface.
 *
 * The Wicket service will discover that OSGi service registration and query the Page for the required information.
 *
 */
